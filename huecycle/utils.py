...
def get_name_from_metadata():
    ...
    test.eq(
        "A:Jo",
        get_qname(
            {"metadata": {"abcd": "jan"}, "type": "A", "owner": {"rid": "id0"}},
...
def find_color_temperature_limits_test():
    group = {
        "id": "841634ec-253c-4830-9070-76c65ad09c84",
    ...
    owner = {
        "id": "bf012818-6e32-4d14-b505-e70c620f4d50",
        "children": [
            {"rid": "f9cfcdf4-d556-4065-b5ff-70b6bac02859", "rtype": "device"},
            {"rid": "1e202743-3d02-4f19-be19-16ff95dc641f", "rtype": "device"},
            {"rid": "1e202743-XXXX-4f19-be19-16ff95dc641f", "rtype": "something"},
        ],
    }
    devic0 = {
        "id": "f9cfcdf4-d556-4065-b5ff-70b6bac02859",
        "services": [
            {"rid": "030ec972-79b2-4fee-a207-2c739a4a1d14", "rtype": "light"},
            {"rid": "030ec972-YYYY-4fee-a207-2c739a4a1d14", "rtype": "burp"},
        ],
        "type": "device",
    }
    devic1 = {
        "id": "1e202743-3d02-4f19-be19-16ff95dc641f",
        "services": [
            {"rid": "20f9e079-b120-4dfd-98f8-760ecab5fc4a", "rtype": "light"},
        ],
        "type": "device",
    }
    light0 = {
        "id": "030ec972-79b2-4fee-a207-2c739a4a1d14",
        "color_temperature": {
            "mirek": 160,
            "mirek_valid": True,
    ...
    light1 = {
        "id": "20f9e079-b120-4dfd-98f8-760ecab5fc4a",
        "color_temperature": {
            "mirek": 160,
            "mirek_valid": True,
