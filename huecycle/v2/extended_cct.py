...
def some_hand_picked_in_hue_range_values():
    ...
    test.eq((0.3129, 0.3231), ct_to_xy(6536)) # Hue: 0.3122 (-0.0007), 0.3282 (+0.0051). Hmmm
    test.eq((0.3135, 0.3237), ct_to_xy(6500)) # Hue: 0.3129 (-0.0006), 0.3289 (+0.0052), Hmmm
    test.eq((0.322 , 0.3318), ct_to_xy(6000)) # Hue: 0.322  (+0.0000), 0.3368 (+0.0050), OK
    test.eq((0.345 , 0.3516), ct_to_xy(5000)) # Hue: 0.3455 (+0.0005), 0.3559 (+0.0043), OK
    test.eq((0.3805, 0.3767), ct_to_xy(4000)) # Hue: 0.3812 (+0.0007), 0.3794 (+0.0027), OK
